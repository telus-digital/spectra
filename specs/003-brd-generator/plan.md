...
template asset (`spectra/templates/brd-template.md`, the canonical structure) shipped
...
│   └── brd-template.md               # NEW — the canonical structure, shipped with the extension
