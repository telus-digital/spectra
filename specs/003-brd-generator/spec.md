...
- The `/brds` folder at the project root is the home for BRDs, created on first run.
...
- The BRD template shipped with the command carries the canonical 14-section structure.
