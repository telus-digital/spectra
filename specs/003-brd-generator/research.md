...
- **Decision**: Ship the canonical template as a bundled asset `spectra/templates/brd-template.md`.
  The command reads the shipped template from the
...
- **Alternatives considered**: title-only `<title>.md` (reads well for a small curated set
