...
**Input**: Maintainer requirement — the Review PR agent (`speckit.spectra.review-pr`):
...
These are reasonable defaults adopted where the source requirement left a question open. Each is a decision that can
