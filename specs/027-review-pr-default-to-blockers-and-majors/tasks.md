...
- [X] T006 Locate every published copy of "Nothing is pre-selected" and separate live claims from records. Live:
  ...
  Records that MUST NOT move: `spectra/CHANGELOG.md:816`, `specs/008-review-pr/`,
  `specs/015-review-context-and-template/`.
- [X] T006a Confirm the source requirement is historical, not governing, before leaving BR-18 contradicted:
  it was a cross-referenced input at Status Draft 0.1.0, not a ratified rule.
...
- [X] T041a Confirm the same grep over `spectra/CHANGELOG.md`, `specs/008-*` and `specs/015-*` **still**
