...
accumulates, is reversible within a run, and preserves locally modified files), are recorded in
`specs/011-integration-coverage/`. They were not known when this contract was written.
