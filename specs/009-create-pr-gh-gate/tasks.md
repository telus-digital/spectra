...
- [X] T035 [P] Annotate the source requirement's **BR-07** and **G5** with a one-line pointer recording that the business rule was superseded at the spec level by `009-create-pr-gh-gate`. Do not restructure it.
