...
| The source requirement's **BR-07**, **G5** | Business rule requiring graceful degradation without `gh` | **Superseded** at the business-rule level by this spec's Clarifications |
