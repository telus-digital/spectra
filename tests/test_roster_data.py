...
class Content(unittest.TestCase):
    ...
    def test_it_carries_the_full_published_roster(self):
        self.assertEqual(len(self.parsed.agents), 48)

    def test_it_splits_into_seventeen_available_and_thirty_one_planned(self):
